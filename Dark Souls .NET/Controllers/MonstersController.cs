...
namespace Dark_Souls.NET.Controllers
{
    ...
    {
        private DbMonster db = new DbMonster();
        ...
        public ActionResult Create([Bind(Include = "ID,NAME,HP,ATTACK,GOLD")] Monster monster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NAME,HP,ATTACK,GOLD")] Monster monster)
        {
            if (ModelState.IsValid)
            {
